      ...
      <main className="max-w-[1100px] mx-auto px-6 py-10">
        ...
        >
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              <Utility className="opacity-60">SHARE LABEL</Utility>
              <Body className="!font-bold !mt-1">
                {label ?? "Compliance Overview"}
              </Body>
            </div>
            <div className="text-right">
              <Utility className="opacity-60">EXPIRES</Utility>
        ...
        <section className="border-2 border-[var(--color-ground)] bg-[var(--color-field)] mb-10">
          <div className="grid grid-cols-1 sm:grid-cols-3 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-[var(--color-ground)]">
            <div className="px-6 py-6">
              <Utility className="opacity-60 mb-3">SCORE</Utility>
              <div className="t-display !text-[75px] !leading-none">
                ...
                <span className="t-h2 !opacity-50 ml-1">/100</span>
              </div>
            </div>
            <div className="px-6 py-6">
              <Utility className="opacity-60 mb-3">ESTIMATED EXPOSURE</Utility>
            ...
            <div className="px-6 py-6">
              <Utility className="opacity-60 mb-3">DEADLINE TALLY</Utility>
...
function Tally({
  ...
  return (
    <div>
      <Utility className="opacity-60 !text-[12px]">{label}</Utility>
      <div
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Utility className="!text-[var(--color-field)] !opacity-70 !text-[12px]">
